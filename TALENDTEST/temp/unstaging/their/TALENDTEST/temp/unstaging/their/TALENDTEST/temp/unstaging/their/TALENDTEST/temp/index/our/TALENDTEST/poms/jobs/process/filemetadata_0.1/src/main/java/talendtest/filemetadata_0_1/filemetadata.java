...
public class filemetadata implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "filemetadata.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(filemetadata.class);
...
///////////////////////    			
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = filemetadata.class.getClassLoader()
					.getResourceAsStream("talendtest/filemetadata_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = filemetadata.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : filemetadata");
		}
		if (enableLogStash) {
