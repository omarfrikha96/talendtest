...
package talendtest.firstjob_0_1;
...
/**
 * Job: firstjob Purpose: firstjob<br>
 * Description: test le premier job <br>
 * 
 * @author Frikha, Omar
...
public class firstjob implements TalendJob {
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_TALENDTEST_firstjob = new byte[0];
		static byte[] commonByteArray_TALENDTEST_firstjob = new byte[0];
		...
		public Boolean isoIsNullable() {
			return true;
		}

		public Boolean isoIsKey() {
			return false;
		}

		public Integer isoLength() {
			return null;
		}

		public Integer isoPrecision() {
			return null;
		}

		public String isoDefault() {
		...
		public String isoOriginalDbColumnName() {
		...
		public Boolean latiIsNullable() {
			return true;
		}

		public Boolean latiIsKey() {
			return false;
		}

		public Integer latiLength() {
			return null;
		}

		public Integer latiPrecision() {
			return null;
		}

		public String latiDefault() {

			return null;

		}

		public String latiComment() {

			return "";

		}

		public String latiPattern() {

			return "";

		}

		public String latiOriginalDbColumnName() {
		...
		public Boolean longiIsNullable() {
			return true;
		}

		public Boolean longiIsKey() {
			return false;
		}

		public Integer longiLength() {
			return null;
		}

		public Integer longiPrecision() {
			return null;
		}

		public String longiDefault() {

			return null;

		}

		public String longiComment() {

			return "";

		}

		public String longiPattern() {

			return "";

		}

		public String longiOriginalDbColumnName() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_TALENDTEST_firstjob.length) {
					if (length < 1024 && commonByteArray_TALENDTEST_firstjob.length == 0) {
						commonByteArray_TALENDTEST_firstjob = new byte[1024];
					} else {
						commonByteArray_TALENDTEST_firstjob = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_TALENDTEST_firstjob, 0, length);
				strReturn = new String(commonByteArray_TALENDTEST_firstjob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_TALENDTEST_firstjob, 0, length);
				strReturn = new String(commonByteArray_TALENDTEST_firstjob, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_TALENDTEST_firstjob) {
				...
				try {
					...
					this.lati = readString(dis);

					this.longi = readString(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeString(this.lati, dos);

				// String

				writeString(this.longi, dos);
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "mO2qvB_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (true) {
					throw new java.lang.Exception("Bad sort criteria: couldn't sort column \"iso\" as num.");
				}
				...
				class Comparablerow1Struct extends row1Struct implements Comparable<Comparablerow1Struct> {
					...
					public int compareTo(Comparablerow1Struct other) {
						...
						if (this.iso == null && other.iso != null) {
							return -1;

						} else if (this.iso != null && other.iso == null) {
							return 1;

						} else if (this.iso != null && other.iso != null) {
							if (!this.iso.equals(other.iso)) {
					...
					class BytesLimit65535_tFileInputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileInputDelimited_1.append("TRIMSELECT" + " = " + "[{TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("iso") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("lati") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("longi") + "}, {TRIM="
				...
				try {
					...
					while (fid_tFileInputDelimited_1 != null && fid_tFileInputDelimited_1.nextRecord()) {
						...
						try {
							...
							row1.iso = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 1;

							row1.lati = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);

							columnIndexWithD_tFileInputDelimited_1 = 2;

							row1.longi = fid_tFileInputDelimited_1.get(columnIndexWithD_tFileInputDelimited_1);
...
// Start of branch "row1"
						if (row1 != null) {
							...
							arrayRowtSortRow_1_SortOut.iso = row1.iso;
							arrayRowtSortRow_1_SortOut.lati = row1.lati;
							arrayRowtSortRow_1_SortOut.longi = row1.longi;
					...
					class BytesLimit65535_tFileOutputDelimited_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFileOutputDelimited_1.append("FILENAME" + " = "
									+ "\"C:/Users/omar-/Desktop/Talend-Studio-20240527_1700-V8.0.1/workspace/out.csv\"");
							log4jParamters_tFileOutputDelimited_1.append(" | ");
				...
				for (int i_tSortRow_1_SortIn = 0; i_tSortRow_1_SortIn < array_tSortRow_1_SortIn.length; i_tSortRow_1_SortIn++) {
					...
					row2.iso = current_tSortRow_1_SortIn.iso;
					row2.lati = current_tSortRow_1_SortIn.lati;
					row2.longi = current_tSortRow_1_SortIn.longi;
					...
					if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
							...
							, "row2", "tSortRow_1_SortIn", "tSortRow_1_SortIn", "tSortIn", "tFileOutputDelimited_1",
					...
					if (row2.iso != null) {
						sb_tFileOutputDelimited_1.append(row2.iso);
					}
					sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row2.lati != null) {
						sb_tFileOutputDelimited_1.append(row2.lati);
					}
					sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row2.longi != null) {
						sb_tFileOutputDelimited_1.append(row2.longi);
					}
					sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
					if (row2.name != null) {
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tSortRow_1_SortIn", "tSortRow_1_SortIn", "tSortIn", "tFileOutputDelimited_1",
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_epa0AC_OEe-nSYwp056bxQ");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2024-06-22T16:37:43.690414300Z");
		...
		try {
			...
			java.io.InputStream inContext = firstjob.class.getClassLoader()
					.getResourceAsStream("talendtest/firstjob_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 104555 characters generated by Talend Cloud Data Management Platform on the
 * 22 juin 2024 à 5:37:43 PM CET
 ************************************************************************************************/