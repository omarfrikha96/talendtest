...
package talendtest.filemetadata_0_1;
 ...
 * @status 
 */
public class filemetadata implements TalendJob {
	static {System.setProperty("TalendJob.log", "filemetadata.log");}

	

	
	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(filemetadata.class);
...
public String getFolder(){
	...
	private final String jobName = "filemetadata";
...
private final JobStructureCatcherUtils talendJobLog = new JobStructureCatcherUtils(jobName, "_Nl6G8DIDEe-82ZYHS27FTw", "0.1");
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(filemetadata.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    ...
    public String loopKey;
				...
				public String CD_TYPE_CLIENTDefault(){
				
					return null;
				
				}
				public String CD_TYPE_CLIENTComment(){
				...
				public String CD_TYPE_CLIENTOriginalDbColumnName(){
				
					return "CD_TYPE_CLIENT";
...
public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	...
	final boolean execStat = this.execStat;
		...
		org.slf4j.MDC.put("_subJobPid", "e9f2lJ_" + subJobPidCounter.getAndIncrement());
	...
	///////////////////////
        ...
        util_tLogRow_3.addRow(new String[]{"CD_TYPE_CLIENT","LB_TYPE_CLIENT",});        
            ...
            if (log.isDebugEnabled()) {
                class BytesLimit65535_tDBInput_1{
                    ...
                    log4jParamters_tDBInput_1.append("Parameters:");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("PASS" + " = " + String.valueOf(routines.system.PasswordEncryptUtil.encryptPassword(context.password)).substring(0, 4) + "...");     
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("QUERY" + " = " + "\"SELECT    \\\"I_OPE\\\".\\\"TB_TYPE_CLIENT\\\".\\\"CD_TYPE_CLIENT\\\",    \\\"I_OPE\\\".\\\"TB_TYPE_CLIENT\\\".\\\"LB_TYPE_CLIENT\\\" FROM \\\"I_OPE\\\".\\\"TB_TYPE_CLIENT\\\"\"");
                        log4jParamters_tDBInput_1.append(" | ");
                        ...
                        log4jParamters_tDBInput_1.append(" | ");
                            log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM="+("false")+", SCHEMA_COLUMN="+("CD_TYPE_CLIENT")+"}, {TRIM="+("false")+", SCHEMA_COLUMN="+("LB_TYPE_CLIENT")+"}]");
                        log4jParamters_tDBInput_1.append(" | ");
 ...
 */
	...
	currentComponent="tLogRow_3";
			...
			if(runStat.update(execStat,enableLogStash,iterateId,1,1
					...
					,"row3","tDBInput_1","\"TB_TYPE_CLIENT\"","tPostgresqlInput","tLogRow_3","tLogRow_1","tLogRow"
...
///////////////////////		
	    		...
	    		if(row3.CD_TYPE_CLIENT != null) { //              
                 row_tLogRow_3[0]=    						    
				                String.valueOf(row3.CD_TYPE_CLIENT)			
					          ;	
	    		...
	    		if(row3.LB_TYPE_CLIENT != null) { //              
                 row_tLogRow_3[1]=    						    
				                String.valueOf(row3.LB_TYPE_CLIENT)			
					          ;	
...
///////////////////////    			
			 		...
			 		if(runStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,"row3",2,0,
			 			"tDBInput_1","\"TB_TYPE_CLIENT\"","tPostgresqlInput","tLogRow_3","tLogRow_1","tLogRow","output")) {
						talendJobLogProcess(globalMap);
					}
 ...
 */
    ...
    public static void main(String[] args){
        final filemetadata filemetadataClass = new filemetadata();

        int exitCode = filemetadataClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'filemetadata' - Done.");
	        }
    ...
    private void readJobInfo(java.io.File jobInfoFile){
		...
		log.info(String.format("Project name: %s\tJob name: %s\tGIT Commit ID: %s\tTalend Version: %s",
				projectName,jobName,jobInfo.getProperty("gitCommitId"), "8.0.1.20240604_0759-patch"));
    ...
    public int runJobInTOS(String[] args) {
        ...
        enableLogStash = "true".equalsIgnoreCase(System.getProperty("audit.enabled"));
	        ...
	        getjobInfo();
			log.info("TalendJob: 'filemetadata' - Start.");
                ...
                org.slf4j.MDC.put("_compiledAtTimestamp","2024-06-26T07:58:04.145103500Z");
        ...
        try {
            ...
            java.io.InputStream inContext = filemetadata.class.getClassLoader().getResourceAsStream("talendtest/filemetadata_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = filemetadata.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        resumeUtil.addLog("JOB_STARTED", "JOB:" + jobName, parent_part_launcher, Thread.currentThread().getId() + "", "","","","",resumeUtil.convertToJsonText(context,ContextProperties.class,parametersToEncrypt));
            ...
            log.info("TalendJob: 'filemetadata' - Started.");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : filemetadata");
        }
		if(enableLogStash) {
...
if (execStat) {
    ...
    resumeUtil.flush();
        ...
        log.info("TalendJob: 'filemetadata' - Finished - status: " + status + " returnCode: " + returnCode );
...
/************************************************************************************************
 *     77468 characters generated by Talend Cloud Data Management Platform 
 *     on the 26 juin 2024 à 8:58:04 AM CET
 ************************************************************************************************/